(function () {
    ...
    function DisplayHome() {
        ...
        // })
        //JQUERY - Most amount of memory heap
        // $("#RandomButton").on("click", function()
        // {
        //    location.href = 'contact.html' 
        // })

        //second most amount of memory heap
    ...
    function DisplayContactList() {
        ...
        if (localStorage.length > 0) {
            ...
            for (const key of keys) {
                ...
                data += `<tr>
                    ...
                    <td class="text-center"><button id="deleteKey" value="" class="btn btn-danger btn-sm delete"><i class="fas fa-trash-alt fa-sm"></i>&nbsp; Delete</button></td>
                </tr>
                `
        ...
        let deletebutton = document.getElementById("deleteKey");
